    ...
    <section className="w-full bg-black text-white py-10 md:py-16 px-4 md:px-20">
      ...
      <div className="max-w-8xl mx-auto mb-10 md:mb-20 text-center lg:text-right">
        ...
        <p className="text-gray-300 leading-relaxed max-w-3xl ml-auto">
          At Classy Villas, timeless charm is reimagined through contemporary craftsmanship. 
          Each residence reflects a perfect blend of heritage elegance and modern sophistication — 
          designed for Chennai’s most discerning families who appreciate artistry, comfort, and legacy living.
        </p>
      </div>
